...
def test_specific_inputs_outputs_crud():
    ...
    response = create_splunkhec_source(base_url, cribl_auth_token, source_id="splunk_hec_source", host="localhost",
                                       port=22002, splunk_hec_api="/services/collector", metadata=metadata,
                                       worker_group=worker_group)
    print("create response: %s " % response.text)
...
if __name__ == '__main__':
    ...
    test_specific_inputs_outputs_crud()
