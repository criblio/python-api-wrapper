...
def create_splunk_destination(base_url, cribl_auth_token, source_id, host, port,
                              pipeline=None,
                              system_fields=None,
                              environment=None,
                              streamtags=None,
...
def update_splunk_destination(base_url, cribl_auth_token, source_id, update_data, worker_group=None):
...
def delete_splunk_destination(base_url, cribl_auth_token, source_id, worker_group=None):
    try:
