...
def create_tcp_source(base_url, cribl_auth_token, source_id, host, port, disabled=False,
                      pipeline=None,
                      send_to_routes=True,
...
def update_tcp_source(base_url, cribl_auth_token, source_id, update_data, worker_group=None):
...
def delete_tcp_source(base_url, cribl_auth_token, source_id, worker_group=None):
    try:
