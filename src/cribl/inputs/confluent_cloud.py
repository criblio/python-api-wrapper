...
def create_confluent_cloud_source(base_url, cribl_auth_token, source_id, brokers, topics, disabled=False,
...
def update_confluent_cloud_source(base_url, cribl_auth_token, source_id, update_data, worker_group=None):
...
def delete_confluent_cloud_source(base_url, cribl_auth_token, source_id, worker_group=None):
    try:
